...
// CODE HERE
const oneLine = (param1,param2) => console.log(`The first parameter is ${param1}. The second parameter is ${param2}.`)
...
greeting('Austin', 'Bolton', (fullName) => console.log(`Hello my full name is ${fullName}`));
